...
router.put('/:courseId/assign-faculties', validateRequest(CourseValidationSchema.assignFacultiesToCourseValidationSchema), CourseController.assignFacultiesToCourse);
